...
# 读取数据
file_path = 'Optimization_Process_3obj.csv'
...
data['SMA_Manpower'] = data[' Manpower'].rolling(window=n, min_periods=1).mean()


# 绘制滑动平均曲线
line_Manpower= ax.plot(data['Iterations'], data['SMA_Manpower'], c="orange",alpha=0.75, linewidth = 2.0, label="Workers")
...
# 保存图像
plt.savefig('Optimization Process of Workers and Forklifts_3obj.pdf', dpi=800, pad_inches=0)
